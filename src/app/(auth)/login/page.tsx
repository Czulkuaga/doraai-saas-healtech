      ...
      <div className="flex w-full min-h-screen overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 md:px-16 lg:px-24 bg-[#f6f8f8] dark:bg-[#102220]">
          <div className="max-w-md w-full">
            ...
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">MediCloud<span className="text-[#13ecda]">.</span></span>
            </div>
        ...
        <div className="hidden lg:flex w-1/2 relative bg-[#102220] overflow-hidden">
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-between p-16">
            ...
            <div className="max-w-xl">
              <div className="inline-flex p-3 bg-[#13ecda]/20 backdrop-blur-sm rounded-xl mb-6">
                <SiBaremetrics size={30} className="material-symbols-outlined text-[#13ecda] text-3xl" />
              </div>
              <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
                Modern Care for <br /><span className="text-[#13ecda] italic">Modern Clinics.</span>
              </h2>
              <p className="text-lg text-slate-300 leading-relaxed mb-8">
                Streamline your patient management with our intuitive interface. Access records, schedule appointments, and manage billing from one unified secure portal.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">
                  ...
                  <p className="text-slate-400 text-sm uppercase tracking-wider font-semibold">Uptime SLA</p>
                </div>
                <div className="p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">
                  <p className="text-[#13ecda] font-bold text-2xl mb-1">HIPAA</p>
                  <p className="text-slate-400 text-sm uppercase tracking-wider font-semibold">Compliant Security</p>
                </div>
              </div>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex -space-x-3">
                <img alt="Doctor 1" className="w-10 h-10 rounded-full border-2 border-[#102220]" data-alt="Professional doctor profile picture" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB_bb4IRnUEbHGc181MTDRMbg4qxfKtCdm8aS3pepKEMTCwZ1HmzYcdfBQyO37mHKA0muJkJDGuF3UA_OiAQkzF376KZrXlByAm3a82bP45n82mA4M1K-HVI1EGWN-9O-C3Pytdo7URjv5Phgzl1NQFqZmi3hz743qPUG5govObFIVEcrBp4endD120j8RUs74mbce0TcGknt20Geqko_oeQuymRvWci7s9ZEuu95zxsNTejPunuLp74yzGYtEkAY29STh7STjl1p2y" />
                <img alt="Doctor 2" className="w-10 h-10 rounded-full border-2 border-[#102220]" data-alt="Healthcare worker smiling profile" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWpsQdOLXitkyk94dpHhawcGIZPFF7OUXCsLQIn32Kv7IkAWxBVFrF8QZj4UWlsM3VtohlSgOA3y6tUS7Cc3wl281ZPF0iqm3CpPcpSG-EhjPYJZqxb1HwWR9sZwyusOUUE3doZfl8Sn-897_P_njy8TKod0d-h1sHe058gs15cBktiujp5DJGGe9GSaasGP9SS2MZI8MzvnwVVKzgIEYsXzPCMvT5dgM_XtULPZmqXnv5RjgajktymSQDseSnP41LjgBXA6Q5TXKI" />
                <img alt="Doctor 3" className="w-10 h-10 rounded-full border-2 border-[#102220]" data-alt="Female medical professional in lab coat" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD3lqkK4JGyJLvjaWdjqGjWqy9659li0I6Kfw4yvOX0SC4OvnF6Saxg8DI0oIEU9Y_67um5lpI8oH5_oUh12rcupVFCEgO-pjWSN2P9wF4Io5JIxtVrlyWV8b5HQ4oh7-H5yVMjnAiIIiJ-oRYhOKx6RRxFdAgdiLXc1-Yl4gFTVBCWUIBdB7o_y3gr9Qc-kEh1Y30dXherct4vG5O2Npcau-P97Ob79uUupxzxaGO9BP58VdRRTFWUEvlw3SUind2s8hCXj8-YmYyQ" />
          ...
          <div className="absolute bottom-0 right-0 w-full opacity-20 pointer-events-none">
            <svg className="w-full h-auto text-[#13ecda]" viewBox="0 0 1000 400" xmlns="http://www.w3.org/2000/svg">
              <path className="opacity-50" d="M0 300 Q 250 150 500 300 T 1000 300" fill="none" stroke="currentColor" strokeWidth="2"></path>
              <path className="opacity-30" d="M0 320 Q 250 170 500 320 T 1000 320" fill="none" stroke="currentColor" strokeWidth="1"></path>
              <path className="opacity-30" d="M0 280 Q 250 130 500 280 T 1000 280" fill="none" stroke="currentColor" strokeWidth="1"></path>
            </svg>
          </div>
        </div>
      </div>
