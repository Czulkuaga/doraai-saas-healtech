...
import type { PreventiveTemplateFilters as QueryType } from "@/lib/types/health-promotion/preventive-template/preventive-template.types";
...
export function PreventiveTemplateFilters({ query, onChange }: Props) {
            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-12">
                <div className="relative lg:col-span-5">
                    ...
                    <input
                        ...
                        placeholder="Rechercher par code, nom, type de service ou spécialité..."
                ...
                <div className="lg:col-span-3">
                    ...
                    >
                        ...
                        {PREVENTIVE_TEMPLATE_STATUS_OPTIONS.map((opt) => (
