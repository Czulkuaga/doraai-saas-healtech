...
export function PatientListShell({
    items,
    totalItems,
    page,
    pageSize,
    ...
    const onQueryChange = (patch: Record<string, string | number | undefined>) => {
        ...
        router.push(`${patientListPath()}${params.toString() ? `?${params.toString()}` : ""}`);
    };
    ...
    return (
        <div className="space-y-6">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                    Gérez les patients liés au module de médecine préventive.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <button
                            type="button"
                            onClick={() => router.push(patientNewPath())}
            ...
            <PatientFilters query={query} onChange={onQueryChange} />
